...
def prepare_parser():
  ...
  parser.add_argument('--exp_model', type=str, default='') # FIXME
  parser.add_argument('--exp_metric', type=str, default='') # FIXME
  ...
  parser.add_argument(
    '--use_multiepoch_sampler', action='store_true', default=True, #default=False
  ...
  parser.add_argument(
    '--G_shared', action='store_true', default=True, #default=False,
    help='Use shared embeddings in G? (default: %(default)s)')
  parser.add_argument(
    '--shared_dim', type=int, default=128, #default=0
    help='G''s shared embedding dimensionality; if 0, will be equal to dim_z. '
         '(default: %(default)s)')
  parser.add_argument(
    '--dim_z', type=int, default=120, #default=128,
    help='Noise dimensionality: %(default)s)')
  parser.add_argument(
    '--z_var', type=float, default=1.0,
    help='Noise variance: %(default)s)')    
  parser.add_argument(
    '--hier', action='store_true', default=True, #default=False
  ...
  parser.add_argument(
    '--G_nl', type=str, default='inplace_relu', #default='relu',
    help='Activation function for G (default: %(default)s)')
  parser.add_argument(
    '--D_nl', type=str, default='inplace_relu', #default='relu'
  ...
  parser.add_argument(
    '--skip_init', action='store_true', default=True, #default=False,
  ...
  ### Bookkeping stuff ###  
  parser.add_argument(
    '--G_eval_mode', action='store_true', default=True, #default=False,
  ...
  parser.add_argument(
    '--weights_root', type=str, default='/data/yyuanaq/collection/BigGAN', #default='weights',
  ...
  parser.add_argument(
    '--experiment_name', type=str, default='100k', #default='',
  ...
  ### EMA Stuff ###
  parser.add_argument(
    '--ema', action='store_true', default=True, #default=False,
    help='Keep an ema of G''s weights? (default: %(default)s)')
  parser.add_argument(
    '--ema_decay', type=float, default=0.9999,
    help='EMA decay rate (default: %(default)s)')
  parser.add_argument(
    '--use_ema', action='store_true', default=True, #default=False
    help='Use the EMA parameters of G for evaluation? (default: %(default)s)')
  parser.add_argument(
    '--ema_start', type=int, default=20000, #default=0
    help='When to start updating the EMA weights (default: %(default)s)')
  
  ### Numerical precision and SV stuff ### 
  parser.add_argument(
    '--adam_eps', type=float, default=1e-6, #default=1e-8,
    help='epsilon value to use for Adam (default: %(default)s)')
  parser.add_argument(
    '--BN_eps', type=float, default=1e-5,
    help='epsilon value to use for BatchNorm (default: %(default)s)')
  parser.add_argument(
    '--SN_eps', type=float, default=1e-6, #default=1e-8,
...
def postprocess_z_y(input_z, input_y, device='cuda', fp16=False, z_var=1.0):
  z_ = Distribution(torch.randn(input_z.size(), requires_grad=False))
  z_.init_distribution('normal', mean=0, var=z_var) + input_z
  z_ = z_.to(device,torch.float16 if fp16 else torch.float32)

  if fp16:
    z_ = z_.half()

  input_y = input_y.to(device, torch.int64) # size: (batch_size, )
  return input_z, input_y
