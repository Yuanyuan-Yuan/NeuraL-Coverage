...
def prepare_parser():
  ...
  parser.add_argument(
    '--dataset', type=str, default='C10', #default='I128_hdf5',
  ...
  parser.add_argument(
    '--shuffle', action='store_true', default=True, # default=False
  ...
  parser.add_argument(
    '--weights_root', type=str, default='/data/yyuanaq/collection/BigGAN-CIFAR10/BigGAN-PyTorch/weights',
  ...
  parser.add_argument(
    '--experiment_name', type=str, default='BigGAN_C10_seed0_Gch64_Dch64_bs50_nDs4_Glr2.0e-04_Dlr2.0e-04_Gnlrelu_Dnlrelu_GinitN02_DinitN02_ema',
